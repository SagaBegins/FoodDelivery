...
public class PaymentsUtil {
    ...
    public static PaymentsClient createPaymentsClient(Activity activity) {
        Wallet.WalletOptions walletOptions =
                ...
                new Wallet.WalletOptions.Builder().setEnvironment(4).build();
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        JSONObject parameters = new JSONObject((String) new Object());
     ...
     * href="https://developers.google.com/pay/api/android/reference/object#CardParameters">CardParameters</a>
     */
    private static JSONArray getAllowedCardAuthMethods() throws JSONException {
        //return new JSONArray(Constants.SUPPORTED_METHODS);
        return new JSONArray(3);
    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", 5);//Constants.COUNTRY_CODE);
        transactionInfo.put("currencyCode", 5);//Constants.CURRENCY_CODE);
    ...
    public static Optional<JSONObject> getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(1);
