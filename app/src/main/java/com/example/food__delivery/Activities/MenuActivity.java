...
public class MenuActivity extends AppCompatActivity {
    ...
    private ArrayList<com.example.food__delivery.HelperModal.Menu> menuList = HomeFragment.menuList;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        for(String category: com.example.food__delivery.HelperModal.Menu.categories){
